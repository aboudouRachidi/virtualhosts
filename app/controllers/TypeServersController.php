...
class TypeServersController extends ControllerBase
{
    ...
    public function confirmDeleteAction(){
    	...
    	if($Stype->getName() == $_POST['name']){
    		...
    		$this->flash->message("success","Le type de serveur '".$_POST['name']."' a �t� supprim� avec succ�s");
    		$this->jquery->get($this->controller,"#refresh");
    		
    	}else{
    		
    		$this->flash->message("error","Le type de serveur '".$Stype->getName()."' n'a pas �t� supprim� : Le nom ne correspond pas ! ");
    		$this->jquery->get($this->controller,"#refresh");
    	}
